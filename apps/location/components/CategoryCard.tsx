...
export function CategoryCard({ category, config: providedConfig, index }: CategoryCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`group bg-white border-t-8 ${borderColor} shadow-xl hover:shadow-2xl transition-all duration-500 rounded-[1.5rem] overflow-hidden flex flex-col h-full`}
    >
