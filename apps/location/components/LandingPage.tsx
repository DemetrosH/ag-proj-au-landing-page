  ...
  return (
    <div className="flex flex-col min-h-screen bg-white font-sans text-gray-900">
      ...
      <main className="bg-white">
        <div className="container mx-auto px-4 max-w-7xl 2xl:max-w-[1600px] 3xl:max-w-[1800px] py-24">
      ...
      <section className="py-12 md:py-24 bg-brand-gray/30 border-t border-gray-100">
        <div className="container mx-auto px-4 max-w-7xl 2xl:max-w-[1600px] 3xl:max-w-[1800px]">
