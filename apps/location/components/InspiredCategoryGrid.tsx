  ...
  return (
    <div id="inventory">
      {showTitle && (
        <div className="mb-16">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl md:text-5xl 5xl:text-8xl font-black text-brand-dark uppercase tracking-tighter mb-4 text-center lg:text-left">
      ...
      */}
      ...
      <div className="hidden xl:grid grid-cols-4 auto-rows-min gap-6 5xl:gap-16 items-start">
      ...
      <div className="grid xl:hidden grid-cols-2 lg:grid-cols-3 auto-rows-min gap-4 sm:gap-6 items-start">
        {/* First 4 categories */}
