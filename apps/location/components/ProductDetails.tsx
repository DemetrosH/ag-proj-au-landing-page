        ...
        {product.features.length > 0 && (
          <div className="space-y-6">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {product.features
                .filter(feature => !['location a', 'location b', 'location c', 'location-a', 'location-b', 'location-c', 'populaire', 'produits-vedette', 'uncategorized'].includes(feature.toLowerCase()))
                .map((feature, idx) => (
