    ...
    >
      ...
      {isVertical ? (
        ...
        <div className="relative z-10 flex-shrink-0 mb-10 md:mb-0 text-center md:text-left">
          <h2 
            className="text-white font-black uppercase tracking-[0.2em] text-4xl sm:text-5xl md:text-7xl lg:text-8xl 3xl:text-9xl 5xl:text-[9.5rem] leading-none"
            style={{
          ...
          <p className="mt-6 text-sm md:text-xl 3xl:text-2xl 5xl:text-4xl text-pink-500 font-bold uppercase tracking-[0.3em] opacity-80 max-w-md 3xl:max-w-2xl 5xl:max-w-4xl">
            Illuminez vos événements avec nos créations sur mesure.
          </p>
